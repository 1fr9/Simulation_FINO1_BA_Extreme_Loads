...
---------------------- INPUT FILES ---------------------------------------------
"FINO1_MAX_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"Wind/vmax/Inflow_vmax_1.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"FINO1_MAX_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"FINO1_MAX_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"HydroDyn/Hydro_wmax_1.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
